...
public class InviteCodeController {
    ...
    @GetMapping
    public Result<Page<InviteCodeDTO>> getAllInviteCodes(
    ...
    @GetMapping("/{id}")
    public Result<InviteCodeDTO> getInviteCode(@PathVariable Long id) {
    ...
    @PostMapping
    public Result<InviteCodeDTO> createInviteCode(@RequestBody InviteCodeDTO dto) {
    ...
    @PutMapping("/{id}")
    public Result<InviteCodeDTO> updateInviteCode(
    ...
    @DeleteMapping("/{id}")
    public Result<Void> deleteInviteCode(@PathVariable Long id) {
    ...
    public Result<InviteCodeDTO> resetUsageCount(@PathVariable Long id) {
